...
export const STATUS_CONFIG: Record<string, StatusConfig> = {
  ...
  on_the_way: { label: 'On The Way',  bg: 'rgba(14,165,233,0.10)',  color: '#7DD3FC', border: 'rgba(14,165,233,0.25)' },
  cancelled:   { label: 'Cancelled',   bg: 'rgba(244,63,94,0.10)',   color: '#FCA5A5', border: 'rgba(244,63,94,0.25)' },
  in_progress: { label: 'In Progress', bg: 'rgba(59,130,246,0.10)',  color: '#93C5FD', border: 'rgba(59,130,246,0.25)' },
