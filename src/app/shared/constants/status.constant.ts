...
export const STATUS_CONFIG: Record<string, StatusConfig> = {
  // ── Order statuses (mirror backend OrderStatus enum) ─────────────────────
  pending:           { label: 'Pending',           bg: 'rgba(2,132,199,0.10)',    color: '#38BDF8', border: 'rgba(2,132,199,0.25)' },
  confirmed:         { label: 'Confirmed',         bg: 'rgba(8,145,178,0.10)',    color: '#67E8F9', border: 'rgba(8,145,178,0.25)' },
  ...
  out_for_pickup:    { label: 'Out for Pickup',    bg: 'rgba(37,99,235,0.10)',    color: '#93C5FD', border: 'rgba(37,99,235,0.25)' },
  ...
  failed:            { label: 'Failed',            bg: 'rgba(220,38,38,0.10)',    color: '#F87171', border: 'rgba(220,38,38,0.25)' },
  // legacy aliases (pre-migration data)
  placed:            { label: 'Pending',           bg: 'rgba(2,132,199,0.10)',    color: '#38BDF8', border: 'rgba(2,132,199,0.25)' },
  accepted:          { label: 'Confirmed',         bg: 'rgba(8,145,178,0.10)',    color: '#67E8F9', border: 'rgba(8,145,178,0.25)' },
  ready:             { label: 'Ready',             bg: 'rgba(124,58,237,0.10)',   color: '#C4B5FD', border: 'rgba(124,58,237,0.25)' },
  picked_up:         { label: 'Out for Pickup',    bg: 'rgba(37,99,235,0.10)',    color: '#93C5FD', border: 'rgba(37,99,235,0.25)' },
  completed:         { label: 'Delivered',         bg: 'rgba(34,197,94,0.10)',    color: '#86EFAC', border: 'rgba(34,197,94,0.25)' },
